...
Array RPCConvertValues(const std::string &strMethod, const std::vector<std::string> &strParams)
{
    ...
    if (strMethod == "searchrawtransactions"     && n > 1) ConvertTo<Array>(params[1], true);
    if (strMethod == "searchrawtransactions"     && n > 2) ConvertTo<Array>(params[2], true);
    if (strMethod == "searchrawtransactions"     && n > 3) ConvertTo<Array>(params[3], true);
